...
void ECGAnalyzerController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ECGAnalyzerController *_t = static_cast<ECGAnalyzerController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ECGAnalyzerController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ECGAnalyzerController.data,
      qt_meta_data_ECGAnalyzerController,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ECGAnalyzerController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ECGAnalyzerController.stringdata0))
        return static_cast<void*>(const_cast< ECGAnalyzerController*>(this));
