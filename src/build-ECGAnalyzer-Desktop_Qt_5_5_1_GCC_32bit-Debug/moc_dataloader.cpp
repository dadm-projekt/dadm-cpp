...
#include "../ECGAnalyzer/dataloader.h"
...
QT_MOC_LITERAL(1, 11, 10), // "dataLoaded"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8) // "loadData"

    },
    "DataLoader\0dataLoaded\0\0loadData"
};
...
void DataLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DataLoader *_t = static_cast<DataLoader *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DataLoader::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataLoader::dataLoaded)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DataLoader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DataLoader.data,
      qt_meta_data_DataLoader,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
